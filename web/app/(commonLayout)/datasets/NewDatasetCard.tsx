...
const CreateAppCard = forwardRef<HTMLAnchorElement>((_, ref) => {
  ...
  return (
    ...
    >
      <a ref={ref} className='group flex grow items-start p-4 cursor-pointer' href={withPrefix('/datasets/create')}>
      ...
      <a className='group flex p-4 items-center gap-1 border-t-[0.5px] border-divider-subtle rounded-b-xl cursor-pointer' href={withPrefix('/datasets/connect')}>
